...
public class LetterImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public void setmLetter(char letter) {
        mLetter = letter;
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getDrawable() == null) {
            //Set a text font size base on the height of the view
            ...
            //Draw text
            canvas.drawText(String.valueOf(mLetter), canvas.getWidth() / 2f - textWidth / 2f, canvas.getHeight() / 2f + textHeight / 2f, mTextPaint);
        }
    }
